...
import { bodyLockStatus, bodyLock, bodyUnlock, bodyLockToggle } from "../functions.js";
	...
	constructor(options) {
		let config = {
			...
			classes: {
				...
				popupActive: 'ui-modal_show', // Добавляется для попапа, когда он открывается
				bodyActive: 'ui-modal-show', // Добавляется для боди, когда попап открыт
			},
			...
			if (this.targetOpen.element) {
				...
				if (this.youTubeCode) {
					...
					if (!this.targetOpen.element.querySelector(`[${this.options.youtubePlaceAttribute}]`)) {
						const youtubePlace = this.targetOpen.element.querySelector('.ui-modal__text').setAttribute(`${this.options.youtubePlaceAttribute}`, '');
					}
